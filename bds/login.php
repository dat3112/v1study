				...
				<div class="header-bottom-body d-flex justify-content-between">						
					...
					<div class="header-bottom-body-menu">		
						<ul>						
							...
							<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children toggle-menu-item-parent"><a href="https://sieuthinhamau.com/san-pham/">Sản phẩm</a>
								<ul class="sub-menu toggle-submenu" style="display: none;">
									<li id="menu-item-47" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-47 toggle-menu-item-parent"><a href="https://sieuthinhamau.com/san-pham/biet-thu/">Biệt thự</a>
										<ul class="sub-menu toggle-submenu" style="display: none;">
										...
										<li id="menu-item-52" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-52 toggle-menu-item-parent"><a href="https://sieuthinhamau.com/san-pham/noi-that/">Nội thất</a>
											<ul class="sub-menu toggle-submenu" style="display: none;">
						...
						<div class="post-content box mark-links entry-content">		
							<div class="woocommerce">
								...
								<form class="woocommerce-form woocommerce-form-login login" method="post">
									...
									<p class="form-row">
										<input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="8c61f54378"><input type="hidden" name="_wp_http_referer" value="/tai-khoan/">				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Đăng nhập">Đăng nhập</button>
