...
<body class="category category-bosuutap">
	<header>		
	...
	<section>
		<article class="article-bosuutap">
			<div id="content-box-bosuutap">
				<h1 class="postsby">
					<span>Category: <span>Bộ sưu tập</span></span>
				</h1>
				<div class="latestPost excerpt ">
					<a href="https://sieuthinhamau.com/bo-suu-tap/biet-thu-2-tang-dien-tich-130m2-bst206087/" title="Hướng dẫn mua bản vẽ thiết kế nhà ở chưa bao giờ dễ dàng đến thế!" id="featured-thumbnail" class="post-image post-image-left schema-featured">
						<div class="featured-thumbnail">
							<img width="680" height="350" src="https://sieuthinhamau.com/wp-content/uploads/2020/11/thiet-ke-nha-biet-thu-2-tang-dien-tich-120m2.jpg" class="attachment-schema-featured size-schema-featured wp-post-image" alt="" loading="lazy" title="">
						</div>                            
					</a>
					<div>
						<h2 class="title front-view-title">
							<a href="#">Biệt thự 2 tầng diện tích 130m2 BST206087</a>
						</h2>
						<div class="post-info">
				...
				<div class="latestPost excerpt ">
					<a href="#" title="Hướng dẫn mua bản vẽ thiết kế nhà ở chưa bao giờ dễ dàng đến thế!" id="featured-thumbnail" class="post-image post-image-left schema-featured">
						<div class="featured-thumbnail">
							<img width="680" height="350" src="https://sieuthinhamau.com/wp-content/uploads/2020/11/Thiet-ke-nha-3-tang-90m2-2.jpg" class="attachment-schema-featured size-schema-featured wp-post-image" alt="" loading="lazy" title="">
						</div>                            
					</a>	
					<div>
						<h2 class="title front-view-title">
							<a href="#">Tổng hợp các mẫu thiết kế nhà 3 tầng hiện đại có 2 mặt tiền ấn tượng</a>
						</h2>
						<div class="post-info">
				...
				<nav class="navigation pagination" role="navigation" aria-label="Bài viết">
					...
					<div class="nav-links"><span aria-current="page" class="page-numbers current">1</span>
						...
						<a class="next page-numbers" href="https://sieuthinhamau.com/tin-tuc/page/2/">Next <i class="fa fa-angle-right"></i></a>
					</div>
				</nav>
