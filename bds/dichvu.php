...
<body>
	...
	<section>
		<article class="article-dichvu">
			<div id="content_box">
				<h1 class="postsby">
					<span>Category: <span>Dịch vụ</span></span>
				</h1>
				<div class="latestPost excerpt ">
					<div>
						<h2 class="title front-view-title">
							<a href="#">Hướng dẫn mua bản vẽ thiết kế nhà ở chưa bao giờ dễ dàng đến thế!</a>
						</h2>
						<div class="post-info">
							<span class="thetime date updated"><i class="fa fa-calendar"></i> <span>26 Tháng Bảy, 2017</span></span>
							<span class="thecomment"><i class="fa fa-comments"></i> <a href="#" itemprop="interactionCount">Không có phản hồi</a></span>
						</div>
					</div>
					<a href="https://sieuthinhamau.com/dich-vu/huong-dan-mua-ban-ve-thiet-ke-nha-o-chua-bao-gio-de-dang-den-the/" title="Hướng dẫn mua bản vẽ thiết kế nhà ở chưa bao giờ dễ dàng đến thế!" id="featured-thumbnail" class="post-image post-image-left schema-featured">
						<div class="featured-thumbnail">
							<img width="680" height="350" src="https://sieuthinhamau.com/wp-content/uploads/2020/02/mua-ho-so-thiet-ke-nha-o-dau-680x350.png" class="attachment-schema-featured size-schema-featured wp-post-image" alt="" loading="lazy" title="">
						</div>                            
					</a>	
				</div>
				<div class="latestPost excerpt ">
					...
					<a href="#" title="Hướng dẫn mua bản vẽ thiết kế nhà ở chưa bao giờ dễ dàng đến thế!" id="featured-thumbnail" class="post-image post-image-left schema-featured">
						<div class="featured-thumbnail">
							<img width="680" height="350" src="https://sieuthinhamau.com/wp-content/uploads/2020/02/chinh-sach-bao-hanh-680x350.png" class="attachment-schema-featured size-schema-featured wp-post-image" alt="" loading="lazy" title="">
						</div>                            
					</a>	
				</div>
