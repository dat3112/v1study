				...
				<div id="post-40" class="g post post-40 page type-page status-publish">
					<div class="single_page">
						<div class="breadcrumb">
							...
							<div class="root"><a rel="v:url" href="https://sieuthinhamau.com">&ensp;Home&nbsp;</a></div>
							<div><i class="fa fa-caret-right"></i></div>
							<div><span>&ensp;Liên hệ</span></div>
						</div>
						<div class="header-gioithieu">
							<h1 class="title entry-title">Liên hệ</h1>
						</div>
						<div class="post-content box mark-links entry-content">
							<p>Mọi chi tiết xin liên hệ theo hotline để nhận thông tin về báo giá, vận chuyển và chính sách bảo hành sản phẩm 0914 58 1221.</p>
							<p><img src="https://sieuthinhamau.com/wp-content/uploads/2017/06/lien-he-sieu-thi-nha-mau.jpg"></p>
							<p>Bản đồ chỉ dẫn đến sieuthinhamau.com</p>
						</div>
					</div>
				</div>
			</div>
